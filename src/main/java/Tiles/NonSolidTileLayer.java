...
public class NonSolidTileLayer extends  TileLayers{
    ...
    public void addTiles() {
        ...
        for(int i=0; i < (w*h); i++){
            ...
            if(temp !=0){
                tiles.add(new NonSolidTile((int)(i%w) * tileWidth,(int) (i/ h) *tileHeight , tileWidth, tileHeight,new Sprite(spriteSheet,(int) ((temp -1) % tilecols ), (int) ((temp -1 ) /tilecols) ,32,32 ) ));
            }
